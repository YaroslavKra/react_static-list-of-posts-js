...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({user:e})=>O.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({comment:e})=>O.jsxs("div",{className:"CommentInfo",children:[O.jsxs("div",{className:"CommentInfo__title",children:[O.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",O.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),O.jsx("p",{className:"CommentInfo__body",children:e.body})]}),Tc=({comments:e})=>O.jsx("div",{className:"CommentList",children:e.map(t=>O.jsx(Lc,{comment:t},t.id))}),Mc=({posts:e})=>O.jsx("div",{className:"PostList",children:e.map(t=>O.jsxs("div",{className:"PostInfo",children:[O.jsxs("div",{className:"PostInfo__header",children:[O.jsx("h3",{className:"PostInfo__title",children:t.title}),O.jsxs("p",{children:[" Posted by  ",O.jsx(Pc,{user:t.user})]})]}),O.jsx("p",{className:"PostInfo__body",children:t.body}),O.jsx("hr",{}),t.comments.length===0?O.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}):O.jsx("div",{className:"CommentList",children:O.jsx(Tc,{comments:t.comments})})]},t.id))}),Rc=()=>{const e=Cc.map(t=>({...t,comments:zc.filter(i=>i.postId===t.id),user:Nc.find(i=>i.id===t.userId)}));return O.jsxs("section",{className:"App",children:[O.jsx("h1",{className:"App__title",children:"Static list of posts"}),O.jsx(Mc,{posts:e})]})};em(document.getElementById("root")).render(O.jsx(Rc,{}));
